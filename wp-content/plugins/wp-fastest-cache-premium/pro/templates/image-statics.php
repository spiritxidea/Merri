<?php
	...
	if($wpfc_server_location = get_option("wpfc_server_location")){
	}else{
			...
			<ul style="list-style: none outside none;float: left;">
				...
				<li style="display:none;">
					<div style="width: 70px;float:left;">
						...
						<div style="color:<?php echo $wpfc_servers["de"]["color"]; ?>;float: right; width: 54px; text-align: center;font-weight:bold;"><?php echo $wpfc_servers["de"]["time"]; ?></div>
					</div>
					<div style="width: 70px;float:left;">
						...
						<div style="color:<?php echo $wpfc_servers["us"]["color"]; ?>;float: right; width: 54px; text-align: center;font-weight:bold;"><?php echo $wpfc_servers["us"]["time"]; ?></div>
					</div>
				</li>
