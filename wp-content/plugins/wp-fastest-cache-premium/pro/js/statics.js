var WpFcStatics = {
	...
	init: function(ajax_url, plugin_dir_url){
		...
		this.set_click_event_server_location();
	},
	set_click_event_server_location: function(){
		var self = this;

		jQuery("input[name='wpfc-server-location']").click(function(e){
			jQuery.ajax({
				type: 'GET', 
				url: self.ajax_url,
				dataType : "json",
				data : {"action": "wpfc_save_server_location_ajax_request", "location" : jQuery(this).val()},
				cache: false,
				timeout: 5000,
