...
<div class="pys-head-footer">
    ...
    <p>For the Facebook Pixel use our <a href="<?php echo admin_url( 'admin.php?page=fb_pixel_pro' ); ?>">dedicated
            integration</a>
        .</p>
</div>
...
<div class="pys-head-footer" style="margin: 15px 0;">
    <label for="pys_head_footer_disable_global" style="font-weight: normal;">
        <input name="pys_head_footer[disable_global]"
               ...
               value="1"> Disable <a href="<?php echo admin_url( 'admin.php?page=head_footer' ); ?>" target="_blank">global</a> head and footer scripts.
    </label>
</div>
