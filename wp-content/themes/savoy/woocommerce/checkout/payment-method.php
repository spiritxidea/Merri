...
?>
<li class="wc_payment_method payment_method_<?php echo $gateway->id . $nm_gateway_active_class; ?>">
	...
	<label for="payment_method_<?php echo $gateway->id; ?>" class="nm-custom-radio-label">
        <span class="nm-gateway-title"><?php echo $gateway->get_title(); ?></span> <?php echo $gateway->get_icon(); ?>
	</label>
