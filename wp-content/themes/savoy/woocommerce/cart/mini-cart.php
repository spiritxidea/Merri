        ...
        <?php
            foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
                ...
                if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                    ...
                    ?>
                    <li id="nm-cart-panel-item-<?php echo esc_attr( $cart_item['product_id'] ); ?>" class="<?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
...
<div class="nm-cart-panel-summary">
    ...
    <div class="nm-cart-panel-summary-inner">
        ...
        <p class="buttons nm-cart-empty-button">
            <a href="<?php echo esc_url( get_permalink( woocommerce_get_page_id( 'shop' ) ) ); ?>" id="nm-cart-panel-continue" class="button border"><?php _e( 'Continue Shopping', 'woocommerce' ); ?></a>
        </p>
